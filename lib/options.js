...
Options.prototype.setDefaultOptionValue = function(optionName) {
    if (this.hasOption(optionName)) {
        this.__options[optionName].setDefault();
    }
    return this;
};
...
Options.prototype.validateOptionValue = function(optionName, value) {
    ...
    return is.call(this.__options[optionName], this.__options[optionName].validate, value);
};
...
Options.prototype.validate = function() {
    if (is('string', arguments[0])) {
        return this.hasOption.apply(this, arguments) && this.validateOptionValue.apply(this, arguments);
    }
    return this.validateOptionValues.apply(this, arguments);
};
